...
/**
 * A {@link com.bumptech.glide.load.Transformation} that can apply a wrapped {@link Bitmap}
 * transformation to both {@link Bitmap}s and {@link com.bumptech.glide.load.resource.gif.GifDrawable}.
 */
